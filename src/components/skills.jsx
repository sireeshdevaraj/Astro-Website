...
export default function Skills(){
    return <div className="tw-mb-4 tw-ring-1 tw-ring-gray-900/5 dark:tw-ring-gray-900 dark:tw-ring-2 tw-p-4 mobile:tw-w-fit mobile:tw-flex-col tablet:tw-w-80 desktop:tw-w-full desktop:tw-grid desktop:tw-grid-cols-2">
